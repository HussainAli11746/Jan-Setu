      ...
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        {stage === 1 && (
          <div className="flex flex-col gap-8 animate-in fade-in duration-300">
            ...
            {/* Top Stepper */}
            <div className="flex items-center justify-center gap-6 sm:gap-12 text-xs font-semibold text-slate-400">
              <div className="flex items-center gap-2">
                <span className="w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-[10px] text-slate-500 font-bold">1</span>
                <span>{t('apply.step1', 'Identify')}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-[10px] text-slate-500 font-bold">2</span>
                <span>{t('apply.step2', 'Check Eligibility')}</span>
              </div>
              <div className="flex items-center gap-2 text-blue-950 font-bold">
                <span className="w-5 h-5 rounded-full bg-[#0A1633] text-white flex items-center justify-center text-[10px] font-bold">3</span>
                <span>{t('apply.step3', 'Apply')}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-[10px] text-slate-500 font-bold">4</span>
            ...
            {/* Checklist Card */}
            <div className="bg-slate-100/90 rounded-3xl p-6 border border-slate-200/60 max-w-2xl mx-auto w-full flex flex-col gap-3">
            ...
            <div className="bg-slate-100/90 rounded-3xl p-6 border border-slate-200/60 max-w-2xl mx-auto w-full flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-start gap-3">
                <ShieldCheck className="w-5 h-5 text-slate-900 shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-sm font-bold text-slate-900">{t('apply.digilocker_title', 'Verify with DigiLocker')}</h4>
                  <p className="text-xs text-slate-500 leading-snug max-w-xs mt-0.5">
              ...
              <button
                ...
                className="w-full sm:w-auto bg-[#0A1633] hover:bg-slate-900 text-white text-xs font-bold px-6 py-3 rounded-xl flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer shrink-0"
              >
            ...
            <div className="max-w-2xl mx-auto w-full flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-xl p-3.5 border border-slate-200">
                  ...
                  <p className="text-xs font-bold text-slate-900 mt-1">{formData.fullName}</p>
                </div>

                <div className="bg-white rounded-xl p-3.5 border border-slate-200">
                  <span className="text-[10px] font-bold uppercase text-slate-400">{t('apply.dob', 'Date of Birth')}</span>
                  <p className="text-xs font-bold text-slate-900 mt-1">{formData.dob}</p>
                </div>
              </div>

              <div className="bg-white rounded-xl p-3.5 border border-slate-200">
                <span className="text-[10px] font-bold uppercase text-slate-400">{t('apply.address', 'Registered Address')}</span>
                <p className="text-xs font-bold text-slate-900 mt-1">{formData.address}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-3.5 border border-slate-200">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className="text-xs font-bold text-slate-900">{formData.bankName} {formData.bankAccount}</p>
                </div>
              </div>
              ...
              <div className="pt-4 flex justify-center">
                <button
                  onClick={() => setStage(2)}
                  className="w-full sm:w-64 bg-[#F8DFD2] hover:bg-[#F2CEBD] text-[#7C2D12] text-xs font-bold py-3.5 px-6 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
        ...
        {stage === 2 && (
          <div className="flex flex-col gap-8 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col gap-2">
              <div className="inline-flex items-center gap-1.5 text-[11px] font-extrabold uppercase tracking-wider text-indigo-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-8 flex flex-col gap-4">
                ...
                <div className="bg-slate-100/90 rounded-2xl p-5 border border-slate-200/60 flex flex-col gap-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                      {t('apply.personal_info', 'Personal Information')}
                    </span>
                    <button onClick={() => setStage(1)} className="text-xs text-indigo-700 hover:text-indigo-900 font-bold flex items-center gap-1 cursor-pointer">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs font-bold text-slate-900 mt-0.5">{formData.fullName}</p>
                    </div>
                    <div>
                      <span className="text-[10px] uppercase font-bold text-slate-400">{t('apply.dob', 'Date of Birth')}</span>
                      <p className="text-xs font-bold text-slate-900 mt-0.5">{formData.dob}</p>
                    </div>
                  </div>

                  <div>
                    <span className="text-[10px] uppercase font-bold text-slate-400">{t('apply.address', 'Residential Address')}</span>
                    <p className="text-xs font-bold text-slate-900 mt-0.5">{formData.address}</p>
                  </div>
                </div>
                ...
                <div className="bg-slate-100/90 rounded-2xl p-5 border border-slate-200/60 flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs font-bold text-slate-900 mt-0.5">{scheme.fullName || scheme.name}</p>
                    </div>
                    <div>
                      <span className="text-[10px] uppercase font-bold text-slate-400">{t('apply.category', 'Category')}</span>
                      <p className="text-xs font-bold text-slate-900 mt-0.5">{scheme.category || 'Welfare'} Assistance</p>
                    </div>
                  </div>

                  <div>
                    <span className="text-[10px] uppercase font-bold text-slate-400">{t('apply.income_declared', 'Annual Income Declared')}</span>
                    <p className="text-xs font-bold text-slate-900 mt-0.5">{formData.annualIncome}</p>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="bg-white rounded-xl p-3 border border-slate-200 flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="text-xs font-bold text-slate-900">Aadhaar Card</p>
                          <p className="text-[10px] text-slate-400">Verified via DigiLocker</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-3 border border-slate-200 flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <FileText className="w-4 h-4 text-slate-500" />
                        <div>
                          <p className="text-xs font-bold text-slate-900">Land Record / Income Proof</p>
                ...
                <div className="bg-slate-100/90 rounded-2xl p-5 border border-slate-200/60 flex flex-col gap-3">
                  ...
                  <div className="bg-white rounded-xl p-3 border border-slate-200 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="text-xs font-bold text-slate-900">{formData.bankName}</p>
                        <p className="text-[10px] text-slate-400">{formData.bankAccount}</p>
                      </div>
                    </div>
              ...
              <div className="lg:col-span-4 flex flex-col gap-4">
                ...
                <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-2xs flex flex-col gap-4">
                  <span className="text-xs font-bold text-slate-900">{t('apply.declaration_title', 'Declaration')}</span>
                  
                  <label className="flex items-start gap-2.5 text-[11px] text-slate-600 leading-relaxed cursor-pointer select-none">
                    <input
                      type="checkbox"
                      checked={declared}
                      onChange={(e) => setDeclared(e.target.checked)}
                      className="mt-0.5 rounded border-slate-300 text-orange-600 focus:ring-orange-500 cursor-pointer"
                    />
                    <span>
                ...
                {/* Security Guarantee */}
                <div className="bg-slate-100/90 rounded-2xl p-4 border border-slate-200/60 flex items-start gap-2.5">
                  <ShieldCheck className="w-4 h-4 text-emerald-700 shrink-0 mt-0.5" />
                  <div>
                    <h6 className="text-[11px] font-bold text-slate-900">{t('apply.secure_submission', 'Secure Submission')}</h6>
