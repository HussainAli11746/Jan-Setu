        ...
        <form onSubmit={handleSubmit} className="text-left flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-900/10 focus:border-blue-900 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-slate-200 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-900/10 focus:border-blue-900 transition-all"
              />
              <button
                type="button"
